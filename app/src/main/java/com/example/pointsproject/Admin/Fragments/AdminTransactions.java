...
import com.example.pointsproject.Admin.Interfaces.AdminTransactionsInterface;
...
public class AdminTransactions extends Fragment {
    ...
    private AdminTransactionsInterface adminTransactionsInterface;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        back = (ImageView) view.findViewById(R.id.backAdminTrans);
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerAdminTrans);
        warn = (TextView) view.findViewById(R.id.txtErrorAdmin);
    ...
    private void getTransactions() {
        ...
        adminTransactionsInterface = retrofit.create(AdminTransactionsInterface.class);
        Call<String> stringCall = adminTransactionsInterface.getTransactions(preferenceHelperAdmin.getEmail());
